      ...
      <div class="col-md-12">
        ...
        @error('brand_id') <strong class="text-danger">{{$message}}</strong>@enderror<br>
         <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{route('products.add.post')}}" enctype="multipart/form-data">
             @csrf
              <div class="row">
                ...
                @endforeach
                 ...
                 <div class="col-lg-12 mb-3">
                    ...
                    <textarea  type="text" id="summernote"   class="form-control" name="short_description">{{old('short_description')}}</textarea>
                 ...
                 <div class="col-lg-12 mb-3" >
                    ...
                    <textarea type="text" id="summernote2" class="form-control" name="long_description">{{old('long_description')}}</textarea>
