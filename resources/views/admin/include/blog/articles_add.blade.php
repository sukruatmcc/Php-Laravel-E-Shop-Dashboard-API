                        ...
                        <form method="post" action="#" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input value="{{old('status')}}" type="number" class="form-control" name="status">
                                ...
                                <div class="col-lg-12 mb-3" >
                                    ...
                                    <textarea type="text" id="summernote" class="form-control" name="description">{{old('description')}}</textarea>
                                    @error('description') <strong class="text-danger">{{$message}}</strong>@enderror
                                </div>
                                <button type="submit" class="btn btn-primary">Articles Add</button>
                            </div>
                        </form>
                    </div>
                </div>
